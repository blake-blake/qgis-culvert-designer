...
To use this plugin, it is required to first install WhiteboxTools.
### For MAC
It is recommended to utilise a [conda virtual environment](https://docs.conda.io/en/latest/) to achieve this on MacOS.
Please refer to [WhiteboxTools Install Guide](https://www.whiteboxgeo.com/manual/wbt_book/python_scripting/scripting.html) and [Whitebox on conda-forge](https://anaconda.org/conda-forge/whitebox)
### For Windows
